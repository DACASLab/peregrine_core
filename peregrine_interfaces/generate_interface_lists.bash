#!/usr/bin/env bash
# Auto-generate CMake list of interface definition files (msg, srv, and action).
# This script scans the local msg/, srv/, and action/ folders and writes a file
# "interface_files.cmake" containing CMake set() commands for MSG_FILES,
# SRV_FILES, and ACTION_FILES relative to the package root.
...
actions=( $(collect_files "${PKG_DIR}/action" action) ) || true
